...
export function RecentProjects({ projectId, item, limit, leadingColumns = 0, onOpen, renderAccessory, ...gesture }: { renderAccessory?: (entry: LaunchItem) => ReactNode; projectId: string; item: LaunchItem; limit: number; leadingColumns?: number; onOpen: (entryId: string) => void; onPointerDown: (e: PointerEvent<HTMLButtonElement>) => void; onPointerMove: (e: PointerEvent) => void; onPointerUp: (e: PointerEvent) => void; onPointerCancel: () => void }) {
