...
public static class LumaNativeInspection {
 ...
 public class Snapshot { public string Title; public long Hwnd; public bool Visible; public int RegionType; public Rect Bounds,Region; public int Backdrop; public uint OutsideHitProcess; public int ImmersiveDarkMode,CaptionColor,TextColor; public int ThemeAttributeResult,CaptionAttributeResult,TextAttributeResult; }
